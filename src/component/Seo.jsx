  ...
  return (
    <section>
      <div className="max-w-[1320px] mx-auto ">
        <h2 className="text-[48px] font-poppins font-semibold leading-[140%] text-[#29313D] w-[666px] mx-auto text-center">
          Provide awsome service with our tools
        </h2>

        <div className="grid grid-cols-2 gap-x-[31px] pt-[60px]">
          <div className="">
