  ...
  return (
    <div className="group relative">
      ...
      >
        ...
        <div
          className={`w-[80px] h-[80px]  absolute bottom-[0px] left-[50%]  -translate-x-1/2  rotate-45 -z-1 opacity-0 md:group-hover:opacity-100 group-hover:bottom-[-40px]  duration-600 ease-in-out   ${overlayClassName}`}
        ></div>
      </div>
    </div>
  );
